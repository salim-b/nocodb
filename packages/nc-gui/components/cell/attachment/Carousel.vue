  ...
  <general-overlay v-model="selectedImage">
    <template v-if="selectedImage">
      <div class="overflow-hidden p-12 text-center relative">
        ...
        <div
          class="select-none group hover:ring active:ring-accent ring-opacity-100 cursor-pointer leading-8 inline-block px-3 py-1 bg-gray-300 text-white mb-4 text-center rounded shadow"
